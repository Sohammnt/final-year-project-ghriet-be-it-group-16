...
l1 = tk.Label(window, text="REGISTRATION FORM", font=("Times new roman",25, "bold"), bg="white", fg="black")
l1.place(x=200, y=50)
...
t5.place(x=380, y=300)

l7 = tk.Label(window, text="Gender :", width=12, font=("Times new roman", 15, "bold"), bg="snow")
l7.place(x=150, y=350)

tk.Radiobutton(window, text="Male", padx=5, width=5, bg="snow", font=("bold", 15), variable=var, value=1).place(x=380,
                                                                                                                y=350)
...
t10.place(x=380, y=550)

btn = tk.Button(window, text="Register", bg="white",font=("",20),fg="black", width=9, height=1, command=insert)
